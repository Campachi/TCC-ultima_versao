...
function giveAdvice($result) {
    if ($result > 0) {
        return "Parabéns! Você conseguiu manter uma boa economia!.";
    } elseif ($result < 0) {
        return "Atenção! Você tem um saldo negativo. Verifique suas despesas e ajuste seu orçamento para evitar dívidas.";
    } else {
        return "Você ficou na risca. Continue monitorando suas finanças e ajustando seu orçamento para alcançar seus objetivos.";
    }
}
?>
