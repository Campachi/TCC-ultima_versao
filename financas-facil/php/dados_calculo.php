...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO finance_calculations (user_id, salario, outras_despesas, agua, energia, mercado, prestacoes_veiculares, gas, condominio, internet, dividas, data) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("idddddddddds", $user_id, $salario, $outras_despesas, $agua, $energia, $mercado, $prestacoes_veiculares, $gas, $condominio, $internet, $dividas, $data);
